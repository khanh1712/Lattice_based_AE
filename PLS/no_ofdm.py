...
N_values = [32]  # Different values of N
M_values = [16]  # QAM Modulation orders (64-QAM, 256-QAM)
num_bits = 5*10**4  # Reduced to speed up simulation
SNR_dB = np.arange(10, 86, 2.5)  # SNR range in dB
